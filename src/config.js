...
// Database Settings
const dBdevelopment = ENV.MONGO_URL || 'mongodb://localhost/foton_api';
const dBproduction = ENV.MONGO_URL || 'mongodb://localhost/foton_api';
...
export const graphqlPort = ENV.PORT || ENV.GRAPHQL_PORT || 5000;
